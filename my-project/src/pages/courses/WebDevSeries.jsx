...
const lessons = [
  { id: "101", title: "Introduction to Web Development", image: "/web1.png", docLink: "#", videoLink: "#" },
  { id: "201", title: "HTML & CSS Basics", image: "/web2.jpg", docLink: "#", videoLink: "#" },
  { id: "202", title: "JavaScript for Web", image: "/web3.jpg", docLink: "#", videoLink: "#" },
];
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme === "dark" ? "bg-gray-900 text-white" : "bg-gray-100 text-black"}`}>
      ...
      <div className="hidden md:block fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 z-40">
        <WebDevSidebar theme={theme} sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />
      </div>
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-6 mt-16 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <Breadcrumb courseName="Web Development Series" theme={theme} />

          <h1 className="text-3xl md:text-4xl font-bold mt-4">Web Development Series</h1>
          ...
          <div className={`p-4 mt-4 rounded-md shadow-md flex flex-col gap-2 ${theme === "dark" ? "bg-yellow-700 text-white" : "bg-yellow-300 text-black"}`}>
            ...
            <p>เอกสารฉบับนี้ยังอยู่ในระหว่างการทำ Series ของ Web Development...</p>
