...
const lessons = [
  { id: "101", title: "Introduction to React.js", image: "/react1.png", docLink: "#", videoLink: "#" },
  { id: "201", title: "React Components & Props", image: "/react2.jpg", docLink: "#", videoLink: "#" },
  { id: "202", title: "State Management", image: "/react3.jpg", docLink: "#", videoLink: "#" },
];
  ...
  return (
    <div className={`min-h-screen flex flex-col ${theme === "dark" ? "bg-gray-900 text-white" : "bg-gray-100 text-black"}`}>
      ...
      <div className="hidden md:block fixed left-0 top-16 h-[calc(100vh-4rem)] w-64 z-40">
        <ReactJsSidebar theme={theme} sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />
      </div>
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-6 mt-16 relative z-10">
        <div className="max-w-5xl mx-auto">
          <Breadcrumb courseName="React.js Series" theme={theme} />

          <h1 className="text-3xl md:text-4xl font-bold mt-4">React.js Series</h1>
