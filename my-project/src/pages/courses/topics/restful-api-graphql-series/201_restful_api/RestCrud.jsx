...
const RestCrud = () => {
  return (
    <div className="max-w-3xl mx-auto p-6 text-left">
      ...
      <p className="mb-4">
        CRUD ย่อมาจาก **Create, Read, Update, Delete** ซึ่งเป็นพื้นฐานของการทำงานกับข้อมูลใน REST API
      </p>

      <h2 className="text-2xl font-semibold mt-6 mb-2">📌 การทำงานของ CRUD</h2>
      <ul className="list-disc pl-6 space-y-2">
        <li>**Create (POST):** เพิ่มข้อมูลใหม่</li>
        <li>**Read (GET):** อ่านข้อมูล</li>
        <li>**Update (PUT/PATCH):** แก้ไขข้อมูล</li>
        <li>**Delete (DELETE):** ลบข้อมูล</li>
      </ul>
