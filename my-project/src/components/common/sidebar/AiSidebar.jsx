...
const sidebarItems = [
    {
      ...
      subItems: [
        ...
        {
          id: "day3",
          title: "Day 3: Matrix Multiplication",
          path: "/courses/ai/matrix-multiplication",
        },
        {
          id: "day4",
          title: "Day 4: Linear Transformation & Feature Extraction",
          path: "/courses/ai/linear-transformation&feature-extraction",
        },
        {
          id: "day5",
          title: "Day 5: Activation Functions",
          path: "/courses/ai/activation-functions",
        },
        {
          id: "day6",
          title: "Day 6: Loss Functions & Optimization",
          path: "/courses/ai/lossfunctions&optimization",
        },
        {
          id: "day7",
          title: "Day 7: Backpropagation & Training Loop",
          path: "/courses/ai/backpropagation&trainingLoop",
        },
        {
          id: "day8",
          title: "Day 8: Regularization & Generalization",
