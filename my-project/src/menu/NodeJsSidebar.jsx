...
const defaultSidebarItems = [
  { id: "101", title: "Node.js Basics" },
  { id: "201", title: "Asynchronous JavaScript" },
  { id: "202", title: "Event Loop & Async" },
  { id: "203", title: "API Development" },
  { id: "204", title: "Express.js Framework" },
  { id: "205", title: "Database Integration" },
];

const NodeJsSidebar = ({ theme, sidebarOpen, setSidebarOpen, sidebarItems = defaultSidebarItems }) => {
  return (
    <>
